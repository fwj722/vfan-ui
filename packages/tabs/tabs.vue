<template>
  <div :class="tabsCls">
    <div v-for="(a, index) of arr" @click="trigger(a, index)" :key="a[key]" :class="{'v-tabs-selected':a[key] == value, 'v-tabs-item-selected':a[key] == value}" class="v-tabs-item">
